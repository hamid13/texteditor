	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int i=0 ; i < trials ; i++) {
				BasicDocument bdock = new BasicDocument(text);
				bdock.getFleschScore();
			}
			
			long endTime = System.nanoTime();
			double duration = (endTime - startTime) / 10000000.0; 
			System.out.print( duration +"\t");
			
			long startTime2 = System.nanoTime();
		
			for (int i=0 ; i < trials ; i++) {
				EfficientDocument edock = new EfficientDocument(text);
				edock.getFleschScore();
			}
			long endTime2 = System.nanoTime();
			double duration2 = (endTime2 - startTime2) / 10000000.0; 
